...
public class Ocean {
    ...
    public void placeOneShipRandomly(Ship ship) {
        ...
        while (isOkToPlace != true) {
            ...
            isOkToPlace = ship.inBoundsToPlaceShipAt(row, column, horizontal, this);
        }
    ...
    /**
     * Returns true if the given location contains a ÓrealÓ ship, still afloat, (not an EmptySea)
    ...
    public boolean shootAt(int row, int column) {
        ...
        if (isWithinOcean == true ) {
            ...
            // if it's an empty sea
                ...
                // keep a record of shootings, but not returning true
                // increasing shot counts only
                this.shotsNum ++;
                shipArray[row][column].shootAt(row, column);
            }
    ...
    public void print() {
        ...
        // "m" to indicate a location that you have fired upon and found nothing there,
